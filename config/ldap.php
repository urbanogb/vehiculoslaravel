            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '172.17.1.24')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'ou=Produccion,dc=s_ardan,dc=local'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'S_ARDAN\ldapSearch'),
                'password' => env('LDAP_PASSWORD', 'LDAPsEARCH'),
